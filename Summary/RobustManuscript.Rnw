...
\item \cite{preisig2006} considers robust M-estimators (trimmed, winsorized, Tukey bi-weight, iteratively reweighted least squares) in edge detection for 3D movement tracking.  Read two papers by Fletcher et al. (2008).
