...
library(circular)
set.seed(150)
rsOrig<-rwrappednormal(10,mu=circular(pi/2),sd=1.25)
plot(rsOrig)
rs<-as.numeric(rsOrig)
...
rs[1]<-rs[1]-2*pi
gmean<-mean(rs)
gmeanVec<-rad*c(cos(gmean),sin(gmean))
...
rsNew<-c(rs,theta+pi)
rsNew[11]<-rsNew[11]-2*pi
gmeanNew<-mean(rsNew)
gmeanVecNew<-rad*c(cos(gmeanNew),sin(gmeanNew))
...
\begin{tikzpicture}[scale=.75]
    ...
    \node at (-3,0) {$-$};\node [right] at(-3,0) {$\pi$};
    \node at (3,0) {$-$}; \node [left] at(3,0) {$0$};
    %\node at (0,3) {$|$}; \node [below] at (0,3) {$\pi/2$};
    %\node at (0,-3) {$|$}; \node [above] at (0,-3) {$3\pi/2$};
    \draw [fill] (2.6752606, -1.357564) circle [radius=0.07]; %Sample 
    \draw [fill] (0.2359919,  2.990704) circle [radius=0.07];
    \draw [fill] (2.3156699,  1.907268) circle [radius=0.07];
    \draw [fill] (1.1481158,  2.771611) circle [radius=0.07];
    \draw [fill] (0.9825748,  2.834528) circle [radius=0.07];
    \draw [fill] (-0.5708459,  2.945188) circle [radius=0.07];
    \draw [fill] (-2.5521680,  1.576844) circle [radius=0.07];
    \draw [fill] (-1.7480938,  2.438066) circle [radius=0.07];
    \draw [fill] (-0.6299558,  2.933114) circle [radius=0.07];
    \draw [fill] (2.4084683,  1.788653) circle [radius=0.07];
    \draw [fill] (0.4265018, 2.0828413) circle[radius=0.125]; %Arithmetic Mean
    \node [below right] at (0.4265018, 2.0828413) {$\overline{\bm R}$};
    \draw [fill] (0.6018199, 2.9390156) circle[radius=0.125]; %Projected Mean
    \node [above right] at (0.6018199, 2.9390156) {$\widehat{\bm S}_E$,$\widehat{\bm S}_R$};
    \draw [->] (0.4265018, 2.0828413) -- (0.5516683, 2.6940976); %Arrow from R-bar to ProjMean
    %\draw [fill] (0.7761543, 2.8978586) circle[radius=0.125]; %Geometric Mean
    %\node [above left] at (0.7761543, 2.8978586) {$\widehat{\bm S}_R$};
\end{tikzpicture}
...
%     \node at (-1.9309514,  2.295959) {$\times$};
    ...
    \draw [fill] (-0.6299558,  2.933114) circle [radius=0.07];
    \draw [fill] (2.4084683,  1.788653) circle [radius=0.07];
    \draw [fill] (0.333018, 1.626309) circle[radius=0.125]; %Arithmetic Mean
    \node [below right] at (0.333018, 1.626309) {$\overline{\bm R}$};
    \draw [fill] (0.6018199, 2.9390156) circle[radius=0.125]; %Projected Mean
    \node [above right] at (0.6018199, 2.9390156) {$\widehat{\bm S}_E$};
    \draw [->] (0.333018, 1.626309) -- (0.5516683, 2.6940976); %Arrow from R-bar to ProjMean
    \draw [fill] (1.547205, 2.570244) circle[radius=0.125]; %Geometric Mean
    \node [above right] at (1.547205, 2.570244) {$\widehat{\bm S}_R$};
    \draw [fill] (-0.6018199, -2.939016) circle [radius=0.07]; %Added outlier
    \node [above right] at (-0.6018199, -2.939016) {$x$};
\end{tikzpicture}
...
\item \cite{preisig2006} considers robust M-estimators (trimmed, winsorized, Tukey bi-weight, iteratively reweighted least squares) in edge detection for 3D movement tracking.

\item  \cite{fletcher2008} claims trying to remove outliers is a fool's errand because that only promotes other observations to outlier status.  Instead they advocate the geometric median, which they provide an algorithm for and prove is unique under certain conditions. Look into \cite{meer1991} and \cite{stewart1999}, they are literature reviews of robust methods in computer vision.

\item \cite{fletcher2009} is the published equivalent of \cite{fletcher2008}, which is a proceedings publication.  
